// JavaScript Document
var db = openDatabase('nova_rock_2015_bands_db', '1.0', 'bands db', 2 * 1024 * 1024);
var total_stages =0;
var day_arr=[];
var day_name_arr=[];
	...
	db.transaction(function (txs) {
		...
		txs.executeSql('select DISTINCT stage_rank, stage from bands order by stage_rank ASC', [], function(txs, results){
						...
						for(var i = 0; i<=total_stages;i++){
									...
									set_up_lineup_page();
									$("#not_time").html("Once This Festival Starts Bands Will Appear Here. Make Sure App is up to date before going to festival. Thank you.<br/><br/>");
								}
